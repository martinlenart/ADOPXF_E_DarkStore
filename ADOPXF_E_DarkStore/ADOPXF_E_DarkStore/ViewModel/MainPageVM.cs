...
namespace ADOPXF_E_DarkStore.ViewModel
{
    public class MainPageVM : BaseVM
    {
        ...
        public void GetItems()
        {
            ...
            itemModelList.Add(new ItemModel { Name = "POLEX Watch ", Image = "luxury_clock.png" , ItemType = Enum.ItemType.Other,Price = "$150"});
            itemModelList.Add(new ItemModel { Name = "Silver Linked Bracelet", Image = "silver_inked.png" ,ItemType = Enum.ItemType.Other, Price = "$250"  });
            itemModelList.Add(new ItemModel { Name = "Brain Rubik's Cube", Image= "brain_color.png", ItemType = Enum.ItemType.Toy, Price = "$10" });
            itemModelList.Add(new ItemModel { Name = "Beyblade", Image= "childhood.png", ItemType = Enum.ItemType.Toy, Price = "$15" });
